package com.example.gd11_b_10823.adapters
...
import com.example.gd11_b_10823.AddEditActivity
import com.example.gd11_b_10823.MainActivity
import com.example.gd11_b_10823.R
...
{
    private var filteredMahsiswaList: MutableList<Mahasiswa>
    private val context:Context

    init {
        filteredMahsiswaList=ArrayList(mahasiswaList)
    ...
    override fun getItemCount(): Int {
        return filteredMahsiswaList.size
    }

    fun setMahasiswaList(mahasiswaList: Array<Mahasiswa>){
        this.mahasiswaList = mahasiswaList.toList()
        filteredMahsiswaList = mahasiswaList.toMutableList()
    }

    override fun onBindViewHolder(holder:ViewHolder, position:Int) {
        val mahasiswa = filteredMahsiswaList[position]
        ...
        holder.btnDelete.setOnClickListener {
            ...
            materialAlertDialogBuilder.setTitle("Konfirmasi")
                .setMessage("Apakah yakin ingin hapus data mahasiswa ini?")
    ...
    override fun getFilter(): Filter {
        return object : Filter(){
            override fun performFiltering(charSequence: CharSequence?): FilterResults {
                ...
                if(charSequenceString.isEmpty()){
                    ...
                    for (mahasiswa in mahasiswaList){
                        if(mahasiswa.nama.lowercase(Locale.getDefault()).contains(charSequenceString.lowercase(
                                Locale.getDefault()
            ...
            override fun publishResults(p0: CharSequence?, p1: FilterResults?) {
                filteredMahsiswaList.clear()
                filteredMahsiswaList.addAll((p1?.values as List<Mahasiswa>))
